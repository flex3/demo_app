...
class BbsControllerTest < ActionController::TestCase
  ...
  test "should create bb" do
    assert_difference('Bb.count') do
      post :create, bb: { QuestLevel: @bb.QuestLevel, QuestMessage: @bb.QuestMessage, QuestName: @bb.QuestName, QuestURL: @bb.QuestURL }
    end
  ...
  test "should update bb" do
    patch :update, id: @bb, bb: { QuestLevel: @bb.QuestLevel, QuestMessage: @bb.QuestMessage, QuestName: @bb.QuestName, QuestURL: @bb.QuestURL }
    assert_redirected_to bb_path(assigns(:bb))
  end
